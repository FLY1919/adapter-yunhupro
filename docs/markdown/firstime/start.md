...
打开[官网控制台](https://www.yhchat.com/control)，复制机器人的 Token：
...
适配器会在启动时自动获取机器人 ID，您只需要提供 Token 即可。
:::
...
配置完成后，保存配置即可。适配器会自动连接到云湖平台并开始接收消息。

![WebSocket配置示例](./../../public/assets/b9b1f3af-cb0c-4401-a20c-97bb5af4ee3c.png)
